...
import { Code2, Loader2, ArrowRight, Mail, Lock, ShieldCheck } from "lucide-react"
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await supabase.auth.signUp({
        ...
        password,
        options: {
          emailRedirectTo: process.env.NEXT_PUBLIC_DEV_SUPABASE_REDIRECT_URL || `${window.location.origin}/problems`,
        },
      })
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between p-12 relative">
        ...
        <div className="relative z-10 space-y-6 animate-slide-up">
          ...
          <p className="text-muted-foreground text-lg max-w-md">
            Join thousands of developers preparing for technical interviews at top companies.
          </p>
      ...
      <div className="flex flex-1 items-center justify-center p-6 lg:p-12 relative z-10">
        <div className="w-full max-w-md space-y-8 animate-slide-up stagger-2">
          ...
          <div className="space-y-2 text-center lg:text-left">
            ...
            <p className="text-muted-foreground">Sign up to start practicing coding problems</p>
          </div>
